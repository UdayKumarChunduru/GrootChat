...
import com.v.grootchat.databinding.ActivitySettingsBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.SaveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                String status = binding.EnterUserStatus.getText().toString();
                String username = binding.EnterUserName.getText().toString();

                HashMap<String , Object> obj = new HashMap<>();
                obj.put("userName", username);
                obj.put("status", username);
        ...
        database.getReference().child("Users").child(FirebaseAuth.getInstance().getUid()).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                Picasso.get().load(users.getProfilepic()).placeholder(R.drawable.profileimage).into(binding.profileImage);

                binding.EnterUserStatus.setText(users.getStatus());
                binding.EnterUserName.setText(users.getUserName());
